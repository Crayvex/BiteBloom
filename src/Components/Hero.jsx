        ...
        <div className="hero-container">
            ...
            <div className="sub-titles">
                <div>
                    ...
                    <h2 className="subtitle-content">Every bite filled <br /> with Taste. </h2>
                </div>
                <div>
                    <p className="subtitle-content">Click down below to view our menu</p>
                    <a href="#menu">Check menu ⇾</a>
                </div>
            </div>
        </div>
        <div>
        <video src="/Videos/output.mp4" muted ref={videoRef} loop />
